module Aurum.Configuration.Shared.Outbound

open System.Text.Json.Serialization
open Aurum
open Aurum.Configuration.Shared.Transport
    ...
    let network =
      Option.map
        (fun streamSetting ->
          ...
          | TransportNetworks.GRPC -> "+gRPC"
          | TransportNetworks.HTTP -> "+HTTP2"
          | TransportNetworks.KCP -> "+mKCP"
          | TransportNetworks.QUIC -> "+QUIC"
          | TransportNetworks.TCP -> "+TCP"
          | TransportNetworks.WS -> "+WS"
          | TransportNetworks.DomainSocket -> "+DomainSocket")
        this.StreamSettings
      |> Option.defaultValue ""
